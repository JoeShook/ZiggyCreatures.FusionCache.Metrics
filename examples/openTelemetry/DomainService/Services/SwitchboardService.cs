...
namespace DomainService.Services
{
    public class SwitchboardService : BackgroundService
    {
        ...
        private DomainServiceConfig? _domainServiceConfig;
        private ILogger<SwitchboardService>? _logger;
        private byte[] _switchboardFileHash;

        public SwitchboardService(string switchboardPath, DomainServiceConfig domainServiceConfig, ILogger<SwitchboardService>? logger)
        {
